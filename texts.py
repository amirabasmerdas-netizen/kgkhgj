"""
AMEL SELF55 - متون پاسخ خودکار به دشمنان
این متون به صورت تصادفی انتخاب می‌شوند
"""
...
# متون منشی (پاسخ خودکار به همه)
SECRETARY_REPLIES = [
    "👋 سلام! در حال حاضر در دسترس نیستم. به زودی پاسخ می‌دهم.",
    "📲 پیامتان دریافت شد. در اولین فرصت پاسخ خواهم داد.",
    "🕐 مشغول هستم. پیامتان را دیدم و به زودی جواب می‌دهم.",
    "✅ پیام شما ثبت شد. لطفاً منتظر بمانید.",
    "🔔 در دسترس نیستم ولی پیامتان رو دیدم. ممنون از صبرتون.",
]

# متون قفل پیوی
PV_LOCK_MESSAGE = "🔒 پیوی من قفل است. لطفاً در گروه پیام بدهید."

# متون ضد لینک
ANTI_LINK_MESSAGE = "🚫 ارسال لینک در این چت مجاز نیست."
